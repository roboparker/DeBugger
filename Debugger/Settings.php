...
class Settings {
	...
	/**
	 * the error levels these settings correspond to
	 * @var int
	 */
	protected $ErrorLV;
	
	/**
	 * the exception codes these settings correspond to.
	 * true means all
	 * @var int|bool
	 */
	...
	/**
	 * where to send email logs
	 * @var string
	 */
	protected $Email;
	
	/**
	 * headers to send with the email
	 * @var string
	 */
	protected $Headers;
	...
	/**
	 * set an email and email headers for emailing logs
	 * @param string $email
